...
```
> !!pb delete 59
[MCDR] [00:46:11] [PB@51f5-worker-heavy/INFO] [prime_backup]: [PB] 将要删除备份 #59: 2024-01-01 12:00:00, 注释: 香猪烤好了
...
通过这些编辑功能，您可以灵活地管理备份，包括重命名、标签管理、删除和清理，确保备份系统的有效性和安全性。
